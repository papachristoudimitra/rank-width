...
#finds the rank of X random decompositions
#input:adjancecy matrix of a graph
#X=iter, can be changed

start.time <- Sys.time() #keep track of comp. time

n <- nrow(graph)  #number of vertices
